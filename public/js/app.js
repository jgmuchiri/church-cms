...
$(document).ready(function () {
    ...
    function fix_position() {
        var uwidth = $('#user-nav').find('> ul').width().css({ width: uwidth, 'margin-left': '-' + uwidth / 2 + 'px' });

        var cwidth = $('#content-header').find('.btn-group').width().css({ width: cwidth, 'margin-left': '-' + uwidth / 2 + 'px' });
    }
