...
class TransactionsController extends Controller
{
    ...
    {
        $this->middleware(['auth'], ['except' => 'manualGift']);
    }
    ...
    function show($id)
    {
        ...
        return view('giving.transaction', compact('txn'));
    }
    ...
    function givingHistory()
    {
        ...
        return view('giving.history', compact('gifts'));
    }
    ...
    function storeGiftOption(Request $request)
    {
        ...
        DB::table('gift_options')->insert($data);
    ...
    function updateGiftOption(Request $request, $id)
    {
        ...
        DB::table('gift_options')->where('id', $id)->update($data);
        flash()->success('Gift option added');
        return redirect()->back();
    }
}
